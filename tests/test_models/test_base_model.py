...
OAOAOAOAOAOAOAOA            Test that an instance is created using the
            key value pair.
OAOAOAOA        '''
        my_model_dict = self.my_model.to_dict()
OAOAOAOA        new_model = BaseModel(**my_model_dict)
        self.assertEqual(new_model.id, self.my_model.id)
OAOAOAOA
    def test_type_created_at(self):
        '''
OAOAOAOA            Test that the new_model's updated_at
...
OAOAOAOA        '''
OAOAOAOAOAOAOAOA        my_model_dict = self.my_model.to_dict()
OAOAOAOA        new_model = BaseModel(**my_model_dict)
OAOAOAOA        new_model_dict = new_model.to_dict()
...
OAOAOAOA
    ...
    def test_save(self):
        ...
        self.new.save()
OAOAOAOA        self.assertNotEqual(self.new.updated_at, old_update)
OAOAOAOAOAOAOAOA
    @unittest.skipIf(storage != "db", "Testing if using DBStorage")
OAOAOAOA    def test_basemodel_hasattr(self):
OAOAOAOA        '''
OAOAOAOA            Checks Class attributes
        '''
        self.assertTrue(hasattr(self.new, "id"))
OAOAOAOA        self.assertTrue(hasattr(self.new, "created_at"))
        self.assertTrue(hasattr(self.new, "updated_at"))

OAOAOAOA    @unittest.skipIf(storage != "db", "Testing if using DBStorage")
